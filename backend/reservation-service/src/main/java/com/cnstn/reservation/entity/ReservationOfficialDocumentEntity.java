...
@Entity
@Table(name = "reservation_official_documents")
public class ReservationOfficialDocumentEntity {
    ...
    private ReservationOfficialDocumentType documentType;
    ...
    public ReservationOfficialDocumentType getDocumentType() {
        return documentType;
    }

    public void setDocumentType(ReservationOfficialDocumentType documentType) {
